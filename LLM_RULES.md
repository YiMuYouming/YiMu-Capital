...
- 周五不因星期五本身关闭 W1；仍按账户风控、情绪档位、W1 硬条件判断
- V 型反弹 W2 不适用
...
```text
final_total_cap_pct = min(account_hard_cap_pct, opportunity_cap_pct, earned_cap_pct)
```

| 字段 | 含义 |
|----------|-----------|
| account_hard_cap_pct | 账户硬风控上限 |
| opportunity_cap_pct | 主线机会容量 |
| earned_cap_pct | 盈利解锁上限 |
| 熔断/连亏2天 | 0% |

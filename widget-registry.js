...
const WidgetRegistry = (function() {
  ...
  var widgets = [
    // 工具类
    { id:'W01', type:'timeline',      title:'时段时间线',   category:'tool',     tier:'slow',   defaultSize:{w:12,h:0.5}, dataPaths:[], priority:'P0' },
    // 决策类
    ...
    { id:'W09', type:'w2-check',      title:'W2低吸+午盘复核',category:'decision',tier:'manual', defaultSize:{w:4,h:5},  dataPaths:['decision.盘中'], priority:'P1' },
    // 数据类

...
const WidgetRegistry = (function() {
  ...
  var widgets = [
    ...
    // 数据类
    { id:'W04', type:'market-overview',title:'市场全景',    category:'data',     tier:'tick',   defaultSize:{w:6,h:3},  dataPaths:['live_index','market.涨跌比','market.涨停家数','market.跌停家数','iwencai.昨日涨停收益','iwencai.连板收益','iwencai.炸板收益'], priority:'P0' },
    { id:'W05', type:'sentiment-dash',title:'情绪仪表盘',   category:'data',     tier:'manual', defaultSize:{w:6,h:5},  dataPaths:['sentiment_nodes','sentiment.情绪值','sentiment.赚钱效应','live_index.上涨家数','live_index.下跌家数'], priority:'P0' },

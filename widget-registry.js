...
const WidgetRegistry = (function() {
  ...
  var widgets = [
    ...
    { id:'W03', type:'position-calc', title:'三层仓位计',   category:'decision', tier:'tick',defaultSize:{w:4,h:4},  dataPaths:['style.总仓位上限','style.连板占比','style.趋势占比','style.实际执行.连板实际','style.实际执行.趋势实际','style.实际执行.首笔上限','risk.熔断触发','risk.连亏天数','positions','live_quotes','pnl_live','rule_state'], priority:'P0' },
    ...
    { id:'W15', type:'positions',     title:'持仓+操作+清仓', category:'risk',     tier:'tick',defaultSize:{w:6,h:6}, dataPaths:['positions','decision.今日操作','live_quotes','pnl_live'], priority:'P0' },
    // 工具类

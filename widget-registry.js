...
const WidgetRegistry = (function() {
  ...
  var widgets = [
    ...
    { id:'W03', type:'position-calc', title:'三层仓位计',   category:'decision', tier:'tick',defaultSize:{w:4,h:4},  dataPaths:['style.总仓位上限','style.连板占比','style.趋势占比','style.实际执行.连板实际','style.实际执行.趋势实际','style.实际执行.首笔上限','risk.熔断触发','risk.连亏天数','positions','live_quotes','pnl_live'], priority:'P0' },
    ...
    // 风控类
    { id:'W14', type:'risk-panel',    title:'账户风控',     category:'risk',     tier:'tick', defaultSize:{w:4,h:5}, dataPaths:['risk.单日熔断线','risk.周累计回撤','risk.月累计回撤','risk.连亏天数','positions','live_quotes','pnl_live'], priority:'P0' },

...
def main(argv=None):
    ...
    summary = {
        ...
        "振幅": [
            index_data.get("上证指数振幅"),
            index_data.get("深证指数振幅"),
            index_data.get("创业指数振幅"),
        ],
